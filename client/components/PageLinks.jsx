  ...
  return (
    <div className="container mx-auto sm">
      <div className="grid grid-cols-4 divide-x divide-black divide-opacity-100 content-center">
        ...
        <button className="bg-transparent hover:bg-gray-300 hover:text-gray-600 font-medium font-sans" as={ NavLink } to='/newsfeed'>
            News Feed
        </button>
        <button className="bg-transparent hover:bg-gray-300 hover:text-gray-600 font-medium font-sans" as={ NavLink } to='/whatshappening'>
          Whats Happening
        </button>
